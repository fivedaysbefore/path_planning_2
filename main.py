...
#print('dict_net_node_coordinate:',dict_net_node_coordinate[1])
#print(path_info_data, list_net_edges[1][1], list_net_nodes, sep='\n')
...
list_net_edges_now, list_net_nodes_now, dict_nodes_labels_now, dict_net_node_coordinate_now, nodes_NUM = \
    get_now_graph.get_now_graph(list_disabled_point, list_disabled_path,
...
#     for i in range(len(list_start_point)):
#         start_point = list_start_point[i]
#         h1, end_point, h2, end_point_2 = get_h.get_hn(start_point, list_end_point, list_disabled_point,
